# Polkadot 跨共识消息（Cross-Consensus Message, XCM）格式

## Version 0, 草稿

本文详细地列出了链之间基于Polkadot进行消息传递的数据格式。 It describes the formal data format, any environmental data which may be additionally required and the corresponding meaning of the datagrams.
